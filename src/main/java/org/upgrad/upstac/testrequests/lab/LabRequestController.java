...
public class LabRequestController {
    ...
    public List<TestRequest> getForTests()  {
        ...
        List<TestRequest> li= testRequestQueryService.findBy(RequestStatus.INITIATED);
            return li; // replace this line with your code
    ...
    public List<TestRequest> getForTester()  {
        ...
        User user = userLoggedInService.getLoggedInUser();
        List<TestRequest> li= testRequestQueryService.findByTester(user);
        return li; // replace this line with your code
    ...
    public TestRequest assignForLabTest(@PathVariable Long id) {
        ...
        try {
            User user = userLoggedInService.getLoggedInUser();
            TestRequest li= testRequestUpdateService.assignForLabTest(id,user);
            return li; // replace this line of code with your implementation
    ...
    public TestRequest updateLabTest(@PathVariable Long id,@RequestBody CreateLabResult createLabResult) {
        ...
        try {
            User user = userLoggedInService.getLoggedInUser();
            TestRequest li= testRequestUpdateService.updateLabTest(id,createLabResult,user);
            return li; // replace this line of code with your implementation
